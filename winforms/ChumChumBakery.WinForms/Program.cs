        ...
        static void Main()
        {
            ...
            try
            {
                string createTbl = @"
                    ...
                    IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME='Products' AND COLUMN_NAME='CreatedBy') ALTER TABLE Products ADD CreatedBy NVARCHAR(100) NULL, CreatedAt DATETIME NULL, UpdatedBy NVARCHAR(100) NULL, UpdatedAt DATETIME NULL;
                    IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME='Invoices' AND COLUMN_NAME='CreatedBy') ALTER TABLE Invoices ADD CreatedBy NVARCHAR(100) NULL, CreatedAt DATETIME NULL, UpdatedBy NVARCHAR(100) NULL, UpdatedAt DATETIME NULL;
                    IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME='Recipes' AND COLUMN_NAME='CreatedBy') ALTER TABLE Recipes ADD CreatedBy NVARCHAR(100) NULL, CreatedAt DATETIME NULL, UpdatedBy NVARCHAR(100) NULL, UpdatedAt DATETIME NULL;
                    IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME='Suppliers' AND COLUMN_NAME='CreatedBy') ALTER TABLE Suppliers ADD CreatedBy NVARCHAR(100) NULL, CreatedAt DATETIME NULL, UpdatedBy NVARCHAR(100) NULL, UpdatedAt DATETIME NULL;
                    IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME='Users' AND COLUMN_NAME='CreatedBy') ALTER TABLE Users ADD CreatedBy NVARCHAR(100) NULL, CreatedAt DATETIME NULL, UpdatedBy NVARCHAR(100) NULL, UpdatedAt DATETIME NULL;
                    IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME='StockOpeningAdj' AND COLUMN_NAME='CreatedBy') ALTER TABLE StockOpeningAdj ADD CreatedBy NVARCHAR(100) NULL, CreatedAt DATETIME NULL, UpdatedBy NVARCHAR(100) NULL, UpdatedAt DATETIME NULL;
                ";
